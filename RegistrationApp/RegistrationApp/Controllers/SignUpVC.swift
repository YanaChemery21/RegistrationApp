...
import UIKit
 ...
 final class SignUpVC: UIViewController {
    ...
    //password
     ...
     //MARK: - Properties
     private var isValidEmail=false {didSet{ updateContinueBthState()}}
     private var isConfPass=false{didSet{ updateContinueBthState()}}
     private var  passwordStrength : PasswordStrength = .veryWeak{didSet{ updateContinueBthState()}}
     ...
     @IBAction func passTFAction(_ sender: UITextField)
    {
     ...
     @IBAction func confPassFAction(_ sender: UITextField){
